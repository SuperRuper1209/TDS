...
public class Stool extends Block {
    ...
    public static final Block ENTRY = new Stool(AbstractBlock.Properties.create(Material.WOOD).harvestLevel(0).harvestTool(ToolType.PICKAXE).sound(SoundType.WOOD).hardnessAndResistance(2.0F, 3.0F)).setRegistryName("tds", "sit");
}
