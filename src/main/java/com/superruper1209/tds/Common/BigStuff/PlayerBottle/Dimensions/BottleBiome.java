...
public class BottleBiome extends BiomeProvider {

    public static final Codec<BottleBiome> CODEC = RegistryLookupCodec.create(Registry.BIOME_REGISTRY)
            .xmap(BottleBiome::new, BottleBiome::getBiomeRegistry).codec();

    private final Biome biome;
    private final Registry<Biome> biomeRegistry;
    private static final List<RegistryKey<Biome>> SPAWN = Collections.singletonList(Biomes.PLAINS);

    public BottleBiome(Registry<Biome> biomeRegistry) {
