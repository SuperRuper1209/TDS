...
public class BedTnt extends CustomTnt<BedTnt> {
    private static final DataParameter<Integer> FUSE = EntityDataManager.createKey(BedTnt.class, DataSerializers.VARINT);
    public static final EntityType<?> ENTRY = EntityType.Builder.create(BedTnt::new, EntityClassification.MISC).setTrackingRange(100).size(1, 1).build("tds:bed_tnt").setRegistryName("tds", "bed_tnt");

    public BedTnt(EntityType<Entity> type, World worldIn) {
        super(type, worldIn);
    }
